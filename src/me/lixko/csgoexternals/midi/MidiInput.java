 ...
 */
package me.lixko.csgoexternals.midi;
...
public class MidiInput implements JackProcessCallback, JackShutdownCallback {
    ...
    public static void main(String[] args) {
        try {
            MidiInput midiSource = new MidiInput();
            midiSource.activate();
            while (true) {
                if (DEBUG) {
            ...
            Logger.getLogger(MidiInput.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private MidiInput() throws JackException {
